...
import image from '../../assets/images//cameracorner/capture.PNG';
import image1 from '../../assets/images/cameracorner/Capture 1.PNG';
import image2 from '../../assets/images/cameracorner/Capture 2.PNG';
import image3 from '../../assets/images/cameracorner/Capture 3.PNG';
...
<div className='mt-8 flex justify-center'>
  <a href="https://camera-corner.web.app/"><button className="btn btn-outline btn-primary m-2">Live Preview</button></a>
  <a href="https://github.com/SHOUROV-HASAN-CSE/camera-corner-client"><button className="btn btn-outline btn-secondary m-2">Client Site Code</button></a>
  <a href="https://github.com/SHOUROV-HASAN-CSE/camera-corner-server"><button className="btn btn-outline btn-secondary m-2">Server Site Code</button></a>
</div>
</div>
