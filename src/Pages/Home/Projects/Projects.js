...
const Projects = () => {
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="card-actions">
     <a href="https://legendary-peony-679d17.netlify.app/"> <button className="btn btn-outline btn-primary">live site</button></a>

     <Link to='/skillshare'><button className="ml-24 btn btn-outline btn-secondary">Details</button></Link>
    </div>
  </div>
</div>
        <div className="card bg-base-100 shadow-2xl">
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="card-actions">
      <a href="https://camera-corner.web.app/"><button className="btn btn-outline btn-primary">live site</button></a>

      <Link to='/cameracorner'><button className="ml-24 btn btn-outline btn-secondary">Details</button></Link>
    </div>
  </div>
</div>
        <div className="card bg-base-100 shadow-2xl">
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="card-actions">
      <a href="https://creative-photography-c9a0d.web.app/"><button className="btn btn-outline btn-primary">live site</button></a>

      <Link to='/creativephotography'><button className="ml-24 btn btn-outline btn-secondary">Details</button></Link>
    </div>
  </div>
</div>
